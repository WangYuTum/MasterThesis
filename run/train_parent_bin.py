...
params_model = {
    ...
    'save_path': '../data/ckpts/attention_bin/CNN-part-gate-img-v3/att_bin.ckpt',
    'tsboard_logs': '../data/tsboard_logs/attention_bin/CNN-part-gate-img-v3',
    'restore_imgnet': '../data/ckpts/imgnet.ckpt', # restore model from where
    'restore_parent_bin': '../data/ckpts/attention_bin/CNN-part-gate-img-v3/att_bin.ckpt-xxx'
}
# define epochs
epochs = 100
