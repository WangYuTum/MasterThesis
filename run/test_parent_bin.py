...
if FINE_TUNE == 1:
    params_model = {
        ...
        'restore_parent_bin': '../data/ckpts/attention_bin/CNN-part-gate-img-v4_large_Flowin/att_bin.ckpt-6000'
    }
    global_iters = 500 # original paper: 500
    save_ckpt_interval = [6300, 6500]
    ...
    params_model = {
        'batch': 1,
        'data_format': 'NCHW',  # optimal for cudnn
        'restore_fine-tune_bin': '../data/ckpts/fine-tune/attention_bin/CNN-part-gate-img-v4_large_Flowin/40ep/'+val_seq_paths[FINE_TUNE_seq].split('/')[-1]+'/fine-tune.ckpt-6500',
