# The script generates trainval set of generic semantic contours on PASCAL Context
# The generated dataset is used to train the final generic contour model
...
def get_train_pairs(rgb_root, mat_root, train_split, val_split):
    ...
    print('Loading {} images/contours ...'.format(len(trainval_list)))
    for idx, file_name in enumerate(trainval_list):
        # get jpg image
...
def main():
    ...
    my_writer = tf.python_io.TFRecordWriter('/work/wangyu/PASCAL_Context_trainval.tfrecord', options=compression_opt)
